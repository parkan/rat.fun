...
echo "deploying drawbridge client to base mainnet $BASE_DRAWBRIDGE_CLIENT_ID"
# Deploy for Base mainnet
netlify deploy --dir=. --prod --auth=$NETLIFY_AUTH_TOKEN --no-build --site $BASE_DRAWBRIDGE_CLIENT_ID
echo "done"