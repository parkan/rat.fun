...
library Prompt {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Prompt", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000050726f6d707400000000000000000000);
