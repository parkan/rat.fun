...
library Index {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Index", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e0000000000000000496e6465780000000000000000000000);
