...
library Traits {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Traits", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000054726169747300000000000000000000);
