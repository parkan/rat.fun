...
library TripCreationCost {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "TripCreationCost", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e0000000000000000547269704372656174696f6e436f7374);
