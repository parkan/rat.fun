...
library LevelList {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "LevelList", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004c6576656c4c69737400000000000000);
