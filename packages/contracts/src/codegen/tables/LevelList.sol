...
library LevelList {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "LevelList", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d000000000000004c6576656c4c69737400000000000000);
