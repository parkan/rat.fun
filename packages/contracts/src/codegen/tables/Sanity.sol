...
library Sanity {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "Sanity", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d0000000000000053616e69747900000000000000000000);
