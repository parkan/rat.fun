...
library LevelMaxBalance {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "LevelMaxBalance", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004c6576656c4d617842616c616e636500);
