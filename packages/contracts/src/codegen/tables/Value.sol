...
library Value {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Value", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000056616c75650000000000000000000000);
