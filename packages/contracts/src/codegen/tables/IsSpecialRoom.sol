...
library IsSpecialRoom {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "IsSpecialRoom", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000049735370656369616c526f6f6d000000);
