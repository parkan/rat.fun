...
library Owner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "Owner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d000000000000004f776e65720000000000000000000000);
