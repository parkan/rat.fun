...
library Owner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Owner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004f776e65720000000000000000000000);
