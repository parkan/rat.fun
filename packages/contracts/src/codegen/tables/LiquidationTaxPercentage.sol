...
library LiquidationTaxPercentage {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "LiquidationTaxPe", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004c69717569646174696f6e5461785065);
