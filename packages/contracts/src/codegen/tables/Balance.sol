...
library Balance {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Balance", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000042616c616e6365000000000000000000);
