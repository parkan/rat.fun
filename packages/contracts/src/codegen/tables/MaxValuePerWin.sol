...
library MaxValuePerWin {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "MaxValuePerWin", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004d617856616c756550657257696e0000);
