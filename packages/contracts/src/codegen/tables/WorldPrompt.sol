...
library WorldPrompt {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "WorldPrompt", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d00000000000000576f726c6450726f6d70740000000000);
