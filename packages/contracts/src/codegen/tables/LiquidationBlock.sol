...
library LiquidationBlock {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "LiquidationBlock", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004c69717569646174696f6e426c6f636b);
