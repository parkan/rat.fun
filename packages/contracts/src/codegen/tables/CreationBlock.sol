...
library CreationBlock {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "CreationBlock", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d000000000000004372656174696f6e426c6f636b000000);
