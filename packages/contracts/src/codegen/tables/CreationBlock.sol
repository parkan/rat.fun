...
library CreationBlock {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "CreationBlock", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004372656174696f6e426c6f636b000000);
