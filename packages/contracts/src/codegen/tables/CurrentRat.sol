...
library CurrentRat {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "CurrentRat", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000043757272656e74526174000000000000);
