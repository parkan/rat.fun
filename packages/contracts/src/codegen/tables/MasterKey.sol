...
library MasterKey {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "MasterKey", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004d61737465724b657900000000000000);
