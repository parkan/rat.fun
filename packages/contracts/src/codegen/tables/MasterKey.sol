...
library MasterKey {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "MasterKey", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d000000000000004d61737465724b657900000000000000);
