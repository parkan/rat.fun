...
library PastRats {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "PastRats", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d0000000000000050617374526174730000000000000000);
