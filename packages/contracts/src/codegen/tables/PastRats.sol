...
library PastRats {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "PastRats", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000050617374526174730000000000000000);
