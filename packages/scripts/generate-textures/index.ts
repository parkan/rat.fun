...
const FIXED_PROMPT = " Absolutely flat texture. Seamless. Hyperrealistic. Extreme detail. 4K. Trending on artstation. Unreal engine."
...
const MODEL = {
  MATERIAL_DIFFUSION: "tstramer/material-diffusion:a42692c54c0f407f803a0a8a9066160976baedb77c91171a01730f9b0d7beeff" as const,
...
const main = async () => {
  ...
  if (options.file) {
    ...
    console.error('Either provide both --prompt and --number, or use --file with a JSON configuration')
    process.exit(1)
  }
