import { Account, Chain, Hex, maxUint256, parseEventLogs, parseUnits, PublicClient, Transport, WalletClient, zeroAddress } from "viem"
...
export async function signPermit2ForUniversalRouter(
  ...
  return await signPermit2(publicClient, walletClient, auctionParams.numeraire.address, addresses.universalRouter, amountIn)
}
