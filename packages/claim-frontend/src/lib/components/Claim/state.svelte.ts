 ...
 * 5. ALREADY_CLAIMED → user has already claimed
 * 6. ERROR → fatal error
 */
...
const VALID_TRANSITIONS: Record<CLAIM_STATE, CLAIM_STATE[]> = {
  ...
  [CLAIM_STATE.CONNECT_WALLET]: [
    CLAIM_STATE.CLAIM,
    CLAIM_STATE.NOT_ELIGIBLE,
    CLAIM_STATE.ALREADY_CLAIMED,
    CLAIM_STATE.ERROR
  ],
  [CLAIM_STATE.CLAIM]: [CLAIM_STATE.CONNECT_WALLET, CLAIM_STATE.ERROR],
  [CLAIM_STATE.NOT_ELIGIBLE]: [CLAIM_STATE.CONNECT_WALLET, CLAIM_STATE.ERROR],
  [CLAIM_STATE.ALREADY_CLAIMED]: [CLAIM_STATE.CONNECT_WALLET, CLAIM_STATE.ERROR],
  [CLAIM_STATE.ERROR]: []
}
