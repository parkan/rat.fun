    ...
    properties: {
      data: {
        ...
        properties: {
          ...
          roomCreationCost: { type: "number", description: "The cost to create the room" },
          maxValuePerWin: { type: "number", description: "The maximum value per win for the room" }
        },
        required: ["roomPrompt", "levelId", "roomCreationCost", "maxValuePerWin"]
      },
      info: {
        type: "object",
        properties: {
