...
export const queries = {
  ...
  worldEvents:
    '*[_type == "worldEvent" && worldAddress == $worldAddress && activationDateTime > now()] | order(activationDateTime asc)', // filter by activationDateTime upcoming, sort by activationDate soonest first
